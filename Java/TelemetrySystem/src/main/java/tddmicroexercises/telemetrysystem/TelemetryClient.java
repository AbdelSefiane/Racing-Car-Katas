...
public class TelemetryClient implements DistantProbe {
    public static final String DIAGNOSTIC_MESSAGE = "AT#UD";
    protected static final String DEFAULT_DIAGNOSTIC_REPORT = "LAST TX rate................ 100 MBPS\r\n" + "HIGHEST " +
            "TX" +
    ...
    protected TelemetryClient(Random connectionEventsSimulator) {
    ...
    public void send(String message) {
        ...
        if (message == DIAGNOSTIC_MESSAGE) {
            ...
            diagnosticMessageResult = DEFAULT_DIAGNOSTIC_REPORT;
